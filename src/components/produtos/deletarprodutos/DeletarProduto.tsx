    ...
    return (
        <div className='container w-full max-w-md mx-auto px-4 pt-20 md:pt-6'>
            ...
            <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
                <header
                    className='py-2 px-4 md:px-6 bg-teal-500 text-white font-bold text-lg md:text-2xl'>
                    Produto
                </header>
                <p className='p-4 md:p-8 text-xl md:text-3xl bg-white h-full'>{produto.nome}</p>
                <div className="flex flex-row">
                    <button
                        className='text-slate-100 bg-red-300 hover:bg-red-400 w-full py-2 text-base md:text-lg'
                        onClick={retornar}
                    >
                        Não
                    </button>
                    <button
                        className='w-full text-slate-100 bg-teal-500 hover:bg-teal-600 flex items-center justify-center text-base md:text-lg'
